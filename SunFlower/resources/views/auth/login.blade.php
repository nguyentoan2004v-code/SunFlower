            ...
            <div>
                ...
                <div class="relative">
                    <input type="password" id="login-password" name="password" required
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-orange-200 focus:border-[#FF6B35] outline-none transition @error('password') border-red-500 focus:ring-red-200 focus:border-red-500 @enderror" 
                           placeholder="Mật khẩu"
                           autocomplete="new-password"> 
                    <button type="button" onclick="togglePassword('login-password', 'eye-icon-login')" class="absolute right-4 top-3 text-gray-400 hover:text-[#FF6B35] transition">
