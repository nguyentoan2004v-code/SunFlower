                    ...
                    <div class="mt-auto">
                        ...
                        <div class="flex flex-col gap-2 pt-3 border-t border-gray-50">
                            <div class="flex gap-2 h-10">
                                ...
                                <form action="{{ route('cart.add', $sp->masp) }}" method="POST">
                                    @csrf
                                    <button type="submit" title="Thêm vào giỏ" class="w-10 h-10 shrink-0 bg-orange-50 text-[#FF6B35] flex items-center justify-center rounded-xl hover:bg-[#FF6B35] hover:text-white transition border border-orange-100">
