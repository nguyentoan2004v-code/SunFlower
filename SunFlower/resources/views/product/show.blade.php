...
<div class="max-w-7xl mx-auto px-4 py-10 min-h-[70vh]">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-0">
                ...
                <div class="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <div class="mt-10 grid grid-cols-2 gap-y-4 gap-x-2 text-sm text-gray-600 font-medium bg-orange-50/50 p-6 rounded-2xl border border-orange-100">
                        ...
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            Hoa tươi nhập trong ngày
                        </div>
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            Tặng kèm thiệp viết tay
                        </div>
                        <div class="flex items-center gap-3">
                            <svg class="w-5 h-5 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            Miễn phí đổi trả nếu héo
                        </div>
                    </div>
                </div>
            </div>
    ...
    @else
        <div class="text-center py-32 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
            ...
            <h2 class="text-3xl font-bold text-gray-800 mb-4">Ối, đóa hoa này đã phai tàn!</h2>
            <p class="text-gray-500 mb-8 text-lg">Sản phẩm có thể đã bị xóa hoặc đường dẫn không chính xác.</p>
            <a href="{{ route('home') }}" class="inline-block bg-[#FF6B35] text-white px-8 py-3.5 rounded-xl font-bold hover:bg-orange-600 transition shadow-md">
                Về Trang Chủ Chọn Hoa Khác
            </a>
        </div>
    @endif
</div>
