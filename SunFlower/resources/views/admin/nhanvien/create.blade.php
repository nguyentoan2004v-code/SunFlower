        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Thông tin Nhân viên mới</h6>
                </div>
                    ...
                    <form action="{{ route('admin.nhanvien.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="hoten" class="form-control @error('hoten') is-invalid @enderror" value="{{ old('hoten') }}" required placeholder="Nhập họ và tên...">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="sdt" class="form-control @error('sdt') is-invalid @enderror" value="{{ old('sdt') }}" required placeholder="Nhập số điện thoại...">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="ngaysinh" class="form-control @error('ngaysinh') is-invalid @enderror" value="{{ old('ngaysinh') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="luong" class="form-control @error('luong') is-invalid @enderror" value="{{ old('luong') }}" required min="0" placeholder="VD: 10000000">
                                @error('luong') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Mật khẩu đăng nhập <span class="text-danger">*</span></label>
                                <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" required placeholder="Nhập mật khẩu (tối thiểu 6 ký tự)">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <select name="maquanly" class="form-select @error('maquanly') is-invalid @enderror">
                                    ...
                                    @foreach($quanlys as $ql)
                                        <option value="{{ $ql->manv }}" {{ old('maquanly') == $ql->manv ? 'selected' : '' }}>
                                            {{ $ql->hoten }} - {{ $ql->manv }}
                                        </option>
                                    @endforeach
                                </select>
