                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="hien_thi" class="form-select">
                            <option value="cong_khai" {{ old('hien_thi', $voucher->hien_thi) == 'cong_khai' ? 'selected' : '' }}>Công khai ở trang đặt hàng</option>
                            <option value="nhap_code" {{ old('hien_thi', $voucher->hien_thi) == 'nhap_code' ? 'selected' : '' }}>Ẩn (Khách phải tự gõ chữ mã)</option>
                        </select>
                    </div>
